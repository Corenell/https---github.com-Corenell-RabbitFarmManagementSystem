...
String half_get_properties = "$oc/devices/67b683d83f28ab3d0384f27e_feedcar/sys/properties/get/request_id=";
String half_response_properties = "$oc/devices/67b683d83f28ab3d0384f27e_feedcar/sys/properties/get/response/request_id=";
String get_messages = "$oc/devices/67b683d83f28ab3d0384f27e_feedcar/sys/messages/down";
String post_properties = "$oc/devices/67b683d83f28ab3d0384f27e_motor/sys/properties/report";
...
void MQTT_response2() {
  ...
  // 在 service 对象中创建一个 "properties" 对象，并设置 "state" 值为 1
